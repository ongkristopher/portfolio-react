    ...
    <div className="dark bg-black">
      <main className="dark flex-1">
        ...
        <section className="w-full py-8 md:py-16 lg:py-20">
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              <h2 className="text-xl font-bold tracking-tighter sm:text-2xl md:text-3xl text-zinc-400">My Projects</h2>
              <p className="mx-auto max-w-[600px] text-gray-500 md:text-base/relaxed lg:text-sm/relaxed xl:text-base/relaxed text-white">
        ...
        <section className="w-full py-8 md:py-16 lg:py-20">
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              <h2 className="text-xl font-bold tracking-tighter sm:text-2xl md:text-3xl text-zinc-400">My Skills</h2>
              <p className="mx-auto max-w-[600px] text-gray-500 md:text-base/relaxed lg:text-sm/relaxed xl:text-base/relaxed text-white">
                Skilled in Cascading Style Sheets (CSS), PHP, HTML, JavaScript, and MySQL.
              </p>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-4 lg:grid-cols-2 lg:gap-8">
              <div className="grid gap-1">
                <h3 className="text-base font-bold text-white">HTML</h3>
                <p className="text-xs text-gray-500 dark:text-gray-400">Hypertext Markup Language</p>
              </div>
              <div className="grid gap-1">
                <h3 className="text-base font-bold text-white">CSS</h3>
                <p className="text-xs text-gray-500 dark:text-gray-400">Cascading Style Sheets</p>
              </div>
              <div className="grid gap-1">
                <h3 className="text-base font-bold text-white">JavaScript</h3>
                <p className="text-xs text-gray-500 dark:text-gray-400">The programming language of the Web</p>
              </div>
              <div className="grid gap-1">
                <h3 className="text-base font-bold text-white">React</h3>
